...
const slugs=["residential-3d-rendering","facade-renders","commercial-3d-rendering","photomontage-rendering","marketing-floor-plans","property-marketing-cgi","streetscape-renders","living-kitchen-dining-renders","alfresco-backyard-renders","industrial-visualisation","office-fit-out-renders","retail-hospitality-renders","education-childcare-renders","3d-site-master-plans","colour-concept-renders"];
